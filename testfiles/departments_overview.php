...
if ($_SESSION['is_admin'])
{
  ...
  $departments  = $db->department_user_overview();
  ...
  <!-- containter fluid -->
    <div class="container-fluid">
      ...
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="javascript:;">department table</a>
      </div>
      <!-- navbar wrapper end -->
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col mr-auto">
              ...
              <a href="#pablo" class="btn btn-primary btn-round">Voeg user toe </a>
              </div>
              </form>
            </div>
          </div>
...
<div class="card">
  ...
  <div class="card-header card-header-rose card-header-icon">
    ...
    <h4 class="card-title">Department gebruikers table</h4>
  </div>
  <!-- end card header  -->
